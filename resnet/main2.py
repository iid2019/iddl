...
from models.resnet_vertical_ensemble import *
...
np.savetxt("./results/train_GC_Ens_BIBD_"+str(args.file)+".csv", train_records, fmt = '%.3e', delimiter = ",")
np.savetxt("./results/test_GC_Ens_BIBD_"+str(args.file)+".csv", test_records, fmt = '%.3e', delimiter = ",")
