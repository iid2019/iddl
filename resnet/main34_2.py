...
from models.resnet_bibd_gc_4 import *
...
# net = ResNet_gc()
net = ResNet_34_bibd_gc_2()
# net = ResNet_bibd_gc()
net = net.to(device)
model_name = 'ResNet34_BIBD_GC_2' # the records will be saved in 
...
def train(epoch, records):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        st_time = time.time()
        outputs = net(inputs)
        rec_time += time.time() - st_time    # the inference time
