...
np.savetxt("./results//ENS_EE/train_ENS_EE_"+str(args.file)+".csv", train_records, fmt = '%.3e', delimiter = ",")
np.savetxt("./results/ENS_EE/test_ENS_EE_"+str(args.file)+".csv", test_records, fmt = '%.3e', delimiter = ",")
