...
from models.resnet_GC_ENS_EE import *
...
np.savetxt("./results/train_GC_ENS_EE_"+str(args.file)+".csv", train_records, fmt = '%.3e', delimiter = ",")
np.savetxt("./results/test_GC_ENS_EE_"+str(args.file)+".csv", test_records, fmt = '%.3e', delimiter = ",")
