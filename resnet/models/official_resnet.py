'''
Reference: The official PyTorch implementation of ResNet: https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
'''
import torch
...
def _resnet(block, layers, progress, **kwargs):
...
def resnet34(progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(BasicBlock, [3, 4, 6, 3], progress,
                   **kwargs)
