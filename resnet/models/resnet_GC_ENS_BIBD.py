...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, num_partition, stride=1):
        ...
        self.conv1 = BibdConv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, groups=num_partition)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = BibdConv2d(planes, planes, kernel_size=3, stride=1, padding=1, groups=num_partition)
