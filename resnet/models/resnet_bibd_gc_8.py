...
class BBasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = BibdConv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, groups=8)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = BibdConv2d(planes, planes, kernel_size=3, stride=1, padding=1, groups=8)
...
def ResNet_bibd_gc_8():
    return BResNet(BBasicBlock, [2,2,2,2])

def ResNet_34_bibd_gc_8():
